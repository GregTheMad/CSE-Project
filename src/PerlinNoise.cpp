...
namespace game
{
	...
	{
		static PerlinNoise  *instance = new PerlinNoise(0);
		return *instance;
	}
		...
		float PerlinNoise::FractalNoise1D(float x, int octNum, float frq, float amp)
		{
			float gain = 1.0f;
			float sum = 0.0f;
		...
		float PerlinNoise::FractalNoise2D(float x, float y, int octNum, float frq, float amp)
		{
			float gain = 1.0f;
			float sum = 0.0f;
		...
		float PerlinNoise::FractalNoise3D(float x, float y, float z, int octNum, float frq, float amp)
		{
			float gain = 1.0f;
			float sum = 0.0f;
